...
export const STAFF_ENABLED = ['reports', 'analytics', 'activity', 'orders', 'payments', 'newOrder', 'tables', 'expenses', 'vendors', 'purchaseOrders', 'reservations', 'dayClose', 'customers', 'waitlist', 'feedback', 'marketing'];
