...
export const STAFF_ENABLED = ['reports', 'analytics', 'activity', 'orders', 'kitchenStation', 'payments', 'newOrder', 'orderKitchen', 'tables', 'qrcode', 'menuItems', 'addItems', 'promotions', 'expenses', 'vendors', 'purchaseOrders', 'reservations', 'dayClose', 'customers', 'waitlist', 'feedback', 'marketing', 'staff'];
