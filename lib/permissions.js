...
export const PERMISSION_GROUPS = [
  {
    ...
    perms: [
      ...
      { key: 'orderKitchen', label: 'Order & Kitchen' },
      ...
      // The 'orderKitchen' permission grants the unified Order & Kitchen
      // station (the Claude-Design-derived waiter app) — usable by any
      // custom role.
    ],
  },
  {
...
export const STAFF_ENABLED = ['reports', 'analytics', 'activity', 'orders', 'payments', 'newOrder', 'orderKitchen', 'tables', 'qrcode', 'menuItems', 'addItems', 'promotions', 'expenses', 'vendors', 'purchaseOrders', 'reservations', 'dayClose', 'customers', 'waitlist', 'feedback', 'marketing', 'staff'];
