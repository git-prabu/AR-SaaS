...
export const STAFF_ENABLED = ['reports', 'analytics', 'activity', 'orders', 'payments', 'expenses', 'vendors', 'purchaseOrders', 'reservations', 'dayClose', 'customers', 'waitlist', 'feedback', 'marketing'];
