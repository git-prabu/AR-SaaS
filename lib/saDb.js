...
export async function createRestaurant(data) {
  // Defaults derived from the canonical Starter plan (single source of truth
  // in lib/plans.js). Previously this file hardcoded plan:'basic' (legacy id)
  // + maxStorageMB:500 + maxItems:10, all of which diverged from lib/db.js
  // and the public-signup defaults — every brand-new restaurant ended up
  // with inconsistent caps depending on where it was created.
