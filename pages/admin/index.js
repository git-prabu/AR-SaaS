                    ...
                    <div
                      ...
                      <div style={{ display:'flex', gap:6 }}>
                        <button onClick={()=>toggleSoldOut(item)}
                          ...
                          style={{ padding:'6px 10px', borderRadius:9, border: isSoldOutToday(item) ? '1.5px solid rgba(90,154,120,0.4)' : '1.5px solid rgba(224,90,58,0.3)', background: isSoldOutToday(item) ? 'rgba(90,154,120,0.1)' : 'rgba(224,90,58,0.07)', color: isSoldOutToday(item) ? '#1A6040' : '#C04A28', fontSize:11, fontWeight:700, cursor:'pointer', whiteSpace:'nowrap' }}>
