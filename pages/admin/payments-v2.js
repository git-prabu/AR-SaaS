...
export default function PaymentsV2() {
  ...
  const iconBtn = (on) => ({ padding: '8px 12px', borderRadius: 10, border: '1px solid var(--line)', background: 'var(--card)', color: on ? 'var(--tx)' : 'var(--tx-3)', fontSize: 14, cursor: 'pointer', minWidth: 38, display: 'inline-flex', alignItems: 'center', justifyContent: 'center' });
  const headRight = (
